...
import com.example.sevenminworkoutapp.databinding.ItemHistoryRowBinding

class ExerciseHistoryItemAdapter(private val items: ArrayList<String>):RecyclerView.Adapter<ExerciseHistoryItemAdapter.ViewHolder>(){
